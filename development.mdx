...
## Export Notified Body Reports

<AccordionGroup>

<Accordion icon="message-bot" title="Export Notified Body Reports">
  You can export a Notified Body Report from the "Export Requirements" dropdown in Table View.
