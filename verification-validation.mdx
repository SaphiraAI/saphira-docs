...
<Accordion icon="list-check" title="Test Case Generation">
...
<Accordion icon="layer-group" title="Multi-Level Testing">
...
<Accordion icon="play" title="Automated Test Execution">
...
<Accordion icon="clipboard-check" title="Test Plan Creation">
...
<Accordion icon="chart-line" title="Results Analysis">
...
<Accordion icon="car" title="Automotive (ISO 26262)">
